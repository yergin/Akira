...
private:
  static constexpr CueDescription _demo[] = {
    { PRESET_COL_ORANGE, PRESET_COL_RAINBOW_OR_BLACK, PRESET_ANIM_GRADIENT },
    { PRESET_COL_ORANGE, PRESET_COL_RAINBOW_OR_BLACK, PRESET_ANIM_THROB },
    { PRESET_COL_ORANGE, PRESET_COL_RAINBOW_OR_BLACK, PRESET_ANIM_STROBE },
    { PRESET_COL_ORANGE, PRESET_COL_RAINBOW_OR_BLACK, PRESET_ANIM_GRADIENT },
    { PRESET_COL_ORANGE, PRESET_COL_RAINBOW_OR_BLACK, PRESET_ANIM_OFF },
    { PRESET_COL_RAINBOW_OR_BLACK, PRESET_COL_RAINBOW_OR_BLACK, PRESET_ANIM_WAVE },
    { PRESET_COL_RAINBOW_OR_BLACK, PRESET_COL_RAINBOW_OR_BLACK, PRESET_ANIM_SPARKLE },
    { PRESET_COL_RAINBOW_OR_BLACK, PRESET_COL_RAINBOW_OR_BLACK, PRESET_ANIM_STROBE },
    { PRESET_COL_RAINBOW_OR_BLACK, PRESET_COL_RAINBOW_OR_BLACK, PRESET_ANIM_SPARKLE },
    { PRESET_COL_RAINBOW_OR_BLACK, PRESET_COL_RAINBOW_OR_BLACK, PRESET_ANIM_OFF }
  };
