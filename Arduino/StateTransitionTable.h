...
constexpr StateTransition stateTransitionTable[] = {
  ...
  { MODE_PROGRAM_ENTER, BUTTONS_A_B_TOGETHER, PRESS, MODE_SLEEP, DO_NOTHING, NO_BUTTON_REQUEST },
  ...
  { MODE_PROGRAM_ENTER, BUTTON_A, HOLD, MODE_BRIGHTNESS, DO_NOTHING, NO_BUTTON_REQUEST },
  { MODE_PROGRAM_ENTER, BUTTON_B, HOLD, MODE_BRIGHTNESS, DO_NOTHING, SWAP_BUTTONS_ON_RELEASE },
  
  { MODE_BRIGHTNESS, BUTTONS_A_B_TOGETHER, PRESS, MODE_SLEEP, DO_NOTHING, NO_BUTTON_REQUEST },
  ...
  { MODE_BRIGHTNESS, BUTTON_A, DOUBLE_TAP, MODE_BRIGHTNESS, BRIGHTNESS_MAXIMUM, NO_BUTTON_REQUEST },
  { MODE_BRIGHTNESS, BUTTON_B, DOUBLE_TAP, MODE_BRIGHTNESS, BRIGHTNESS_MINIMUM, NO_BUTTON_REQUEST },
