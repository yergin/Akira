...
constexpr StateTransition stateTransitionTable[] = {
  ...
  { MODE_OFF, BUTTONS_A_B_TOGETHER, HOLD, MODE_PROGRAM_ENTER, DO_NOTHING, NO_BUTTON_REQUEST },
  ...
  { MODE_PERFORM, BUTTONS_A_B_TOGETHER, PRESS, MODE_OFF, DO_NOTHING, NO_BUTTON_REQUEST },
  ...
  { MODE_PROGRAM, BUTTONS_A_B_TOGETHER, PRESS, MODE_OFF, DO_NOTHING, NO_BUTTON_REQUEST },
